...
namespace CarDealership.Data.Migrations
{
    ...
    [Migration("20241126210258_AddUserVehicleWatchlist")]
    partial class AddUserVehicleWatchlist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarDealership.Data.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3140bfa8-f536-474c-976a-90f0cac1eca5"),
                            Name = "София"
                        },
                        new
                        {
                            Id = new Guid("7a6449dc-9ff3-4a85-bc66-5181fe26c739"),
                            Name = "Пловдив"
                        },
                        new
                        {
                            Id = new Guid("d22358b8-9aae-40b4-bdb9-adaf9bf91439"),
                            Name = "Варна"
                        },
                        new
                        {
                            Id = new Guid("83dbb3fd-babd-44a9-a03e-4424988e0750"),
                            Name = "Плевен"
                        },
                        new
                        {
                            Id = new Guid("72824087-28c3-45de-8739-499436096d7b"),
                            Name = "Бургас"
                        });
                });
            ...
            modelBuilder.Entity("CarDealership.Data.Models.VehicleCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1aa8203b-8f41-48e9-87d7-e0360ec98944"),
                            Name = "Седан"
                        },
                        new
                        {
                            Id = new Guid("ab256598-831b-40eb-9884-5081232007d8"),
                            Name = "Комби"
                        },
                        new
                        {
                            Id = new Guid("108aa025-604e-4cde-9a6b-600d0e362f95"),
                            Name = "Кабрио"
                        },
                        new
                        {
                            Id = new Guid("a72ec242-e543-4242-b74a-c76c84923c1d"),
                            Name = "Хечбег"
                        },
                        new
                        {
                            Id = new Guid("cc6ef130-1f54-46ce-a699-43181d716eda"),
                            Name = "Ван"
                        },
                        new
                        {
                            Id = new Guid("64ef1105-201a-4d55-a2bf-fd62d492a3c3"),
                            Name = "Пикап"
                        },
                        new
                        {
                            Id = new Guid("b69648c4-c420-415a-a76d-9d57bbda8673"),
                            Name = "Купе"
                        },
                        new
                        {
                            Id = new Guid("b4e86c63-2f92-4614-bd8e-1229efda67b8"),
                            Name = "Джип"
                        },
                        new
                        {
                            Id = new Guid("29444a9c-be8e-40ef-83ea-64ee79bb46ce"),
                            Name = "Камион"
                        },
                        new
                        {
                            Id = new Guid("e31575c4-67f3-4c72-ad0e-aefd1ec699da"),
                            Name = "Бус"
                        });
                });
            ...
            modelBuilder.Entity("CarDealership.Data.Models.VehiclePurpose", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4869ee82-4f7b-4b0b-b2d4-e49748be8265"),
                            Name = "Икономичен"
                        },
                        new
                        {
                            Id = new Guid("ab35c39d-14c6-468b-81e1-b87d02bb771b"),
                            Name = "Икономичен Комби"
                        },
                        new
                        {
                            Id = new Guid("d4df8611-6375-45f1-972e-306ee0c419d3"),
                            Name = "Компактен"
                        },
                        new
                        {
                            Id = new Guid("c28d679f-84a1-4f7c-946b-74cf6e24c9d6"),
                            Name = "Стандартен"
                        },
                        new
                        {
                            Id = new Guid("210f8015-c6d8-49d4-8908-542cf97d06a2"),
                            Name = "Стандартен Комби"
                        },
                        new
                        {
                            Id = new Guid("757299d4-0bb6-4451-9528-8c649f38a416"),
                            Name = "Голям"
                        },
                        new
                        {
                            Id = new Guid("c95151b6-92e3-4fee-81ca-a882cd50c824"),
                            Name = "Луксозен"
                        });
                });
            ...
            modelBuilder.Entity("CarDealership.Data.Models.VehicleType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("db2fe2bd-3d8f-44f5-a983-07114939d184"),
                            Name = "Автомобил"
                        },
                        new
                        {
                            Id = new Guid("25177076-c860-441d-a2a5-11e2dafcefcc"),
                            Name = "Камион"
                        },
                        new
                        {
                            Id = new Guid("93bf6009-4033-4678-83b1-4729728c8811"),
                            Name = "Бус"
                        });
                });
